...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP session management", "[OldWAMP][Basic]" )
{
...
//------------------------------------------------------------------------------
SCENARIO( "Old Using alternate transport and/or serializer", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP Pub-Sub", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP Subscription Lifetimes", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP RPCs", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP Registation Lifetimes", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old Nested WAMP RPCs and Events", "[OldWAMP][Basic]" )
{
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP Connection Failures", "[OldWAMP][Basic]" )
{
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP RPC Failures", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old Invalid WAMP URIs", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old WAMP Disconnect/Leave During Async Ops", "[OldWAMP][Basic]" )
{
GIVEN( "an IO service and a TCP connector" )
{
    AsioContext ioctx;
...
//------------------------------------------------------------------------------
SCENARIO( "Old Outbound Messages are Properly Enqueued", "[OldWAMP][Basic]" )
{
GIVEN( "these test fixture objects" )
{
    AsioContext ioctx;
