...
//------------------------------------------------------------------------------
inline void decodeMsgpackArray(VariantBuilder& builder,
...
//------------------------------------------------------------------------------
inline void decodeMsgpackMap(VariantBuilder& builder,
...
//------------------------------------------------------------------------------
inline void decodeMsgpackObject(VariantBuilder& builder,
...
/** @throws error::Decode if there is an error while parsing the Msgpack
            payload. */
//------------------------------------------------------------------------------
inline void Msgpack::decode(const std::string& from, Variant& to)
{
...
//------------------------------------------------------------------------------
inline void Msgpack::encode(const Variant& from, std::ostream& to)
{
...
//------------------------------------------------------------------------------
inline void Msgpack::encode(const Variant& from, std::string& to)
{
