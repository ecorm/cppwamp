...
#include "../transports/httpaction.hpp"
#include "../api.hpp"
#include "httpjob.hpp"
...
CPPWAMP_INLINE void AnyHttpAction::execute(internal::HttpJob& job)
{
...
CPPWAMP_INLINE void
HttpAction<HttpWebsocketUpgrade>::execute(HttpJob& job)
{
    const auto& req = job.request();
    if (!boost::beast::websocket::is_upgrade(req))
    {
        return job.balk(HttpStatus::upgradeRequired,
