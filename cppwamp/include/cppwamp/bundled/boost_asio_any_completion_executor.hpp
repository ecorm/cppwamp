...
/**
 * The @c any_completion_executor type is a polymorphic executor that supports the set
 * of properties required by completion handlers. It is defined as the
...
public:
  ...
  /// Copy constructor.
  BOOST_ASIO_DECL any_completion_executor(const any_completion_executor& e) BOOST_ASIO_NOEXCEPT;

#if defined(BOOST_ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
  /// Move constructor.
  BOOST_ASIO_DECL any_completion_executor(any_completion_executor&& e) BOOST_ASIO_NOEXCEPT;
...
template <>
BOOST_ASIO_DECL any_completion_executor any_completion_executor::require(
