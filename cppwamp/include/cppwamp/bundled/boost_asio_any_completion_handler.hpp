...
public:
  ...
  {
    uninit_deleter d{(get_associated_allocator)(h, boost::asio::recycling_allocator<void>())};
  ...
  void destroy()
  {
    deleter d{(get_associated_allocator)(handler_, boost::asio::recycling_allocator<void>())};
    d(this);
  }
